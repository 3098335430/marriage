	...
	<form action="document/updateDocument" method="post">
	     <label>文档id：</label> 
			<input value="${document.did}" class="itxt"
				...
				tabindex="1" name="did" style="width:800px;height:50px"/> <br /> <br /> 
			<label>文档名：</label> 
			<input value="${document.title}" class="itxt"
				type="text" placeholder="" autocomplete="off"
				tabindex="1" name="title" style="width:800px;height:50px"/> <br /> <br /> 
			<label>文档内容：</label>
			<input class="itxt" type="text"
				value="${ document.content}" tabindex="1" name="content" 
				style="width:800px;height:80px"/> <br /> <br />
			<label>文档标签：</label>
			<input class="itxt" type="text"
				value="${ document.label}" tabindex="1" name="label" 
				style="width:800px;height:50px"/> <br /> <br />
