...
<body>
	...
	<div id="main">
		<div id="book">
			<div class="book_cond">
			<!-- 
			 当发送Post请求时，是通过请求体来传递请求参数，所以在Servlet 中就不能获取到请求参数了，
			 所以这里最好不要使用post 请求，改用get 请求，但是get 请求会自动覆盖action 属性中的参数
			 ，所以当使用get 请求时，我们只能通过表单项来传递请求参数
					...
					<c:forEach items="${page.data }" var="book">
						<div class="b_list">
							...
							<div class="book_info">
								...
								<%-- 	<a style="color:blue" href="client/CartServlet?method=add2Cart&bookId=${book.id}">
									   加入购物车
									</a>--%>
								</div>
							</div>
