...
<div id="header">
	...
	<form action="user/updateUser" method="post">
			...
			<input value="${ user.userId}" class="itxt"
				...
				tabindex="1" name="userId" style="width:800px;height:60px"/> <br /> <br /> 
			<label>用户名称：</label> 
			<input value="${ user.username}" class="itxt"
				type="text" placeholder="" autocomplete="off"
				tabindex="1" name="username" style="width:800px;height:60px"/> <br /> <br /> 
			<label>用户密码：</label>
			<input class="itxt" type="password"
				value="${ user.password}" tabindex="1" name="password" style="width:800px;height:60px"/> <br /> <br />
